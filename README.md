This is an example project used in a couple of tutorials that show the use of the **Model View Presenter** pattern on Android and a little example with **RxAndroid** to achieve an animation effect.
